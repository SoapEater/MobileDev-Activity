...
public class MainActivity extends AppCompatActivity
{
    ...
    {
        super.onResume();
        Toast.makeText(this, "Beep Boop It is RESUME!!", Toast.LENGTH_SHORT).show();
    }
    //--------------------------------------------------------------------------------------------//
    @Override
    ...
    {
        super.onPause();
        Toast.makeText(this, "Beep Boop It is PAUSE!!", Toast.LENGTH_SHORT).show();
    }
    //--------------------------------------------------------------------------------------------//
    @Override
    ...
    {
        super.onStop();
        Toast.makeText(this, "Beep Boop It is STOP!!", Toast.LENGTH_SHORT).show();
    }
    //--------------------------------------------------------------------------------------------//
    @Override
